...
\par The Web3 movement is currently pushing for a more decentralized (and democratic) architecture for the Internet. As such, decentralized systems are gaining popularity once more. A particular case of peer-to-peer usage appears in Swarm Computing, where highly heterogeneous devices can cooperate directly and in a mostly autonomous fashion, demands for highly flexible and robust decentralized solutions, including distributed and decentralized membership, as well as communication protocols.
