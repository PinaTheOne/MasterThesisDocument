...
\ntsetup{abstractorder={pt={pt,en}}}   % The order for abstracts for a specific language
...
\ntsetup{tocintoc=false}       % Shall table of contects be listed in itself?
...
\ntsetup{print/frontmatter=true}% Print the front matter
