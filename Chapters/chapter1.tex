...
In this thesis, we address the problem of managing parameters of peer-to-peer protocols that govern decentralized systems, focussing on less complex reconfigurations in order to explore different ways of managing such systems.
...
Evaluation should be done by means of a case study, where a protocol should be reconfigured automatically to achieve better performance, which will be compared to non self-configuring alternatives.

\section*{Contributions}
\label{sec:contributions}

This dissertation contributes with a new approach of development of self-adaptive decentralized systems, proposing a new architecture, where a centralized component oversees system monitoring and adaptation (with cooperation from each node on monitoring). It also contributes with an implementation of this architecture on top of the Babel-Swarm Framework\cite{Fouto2022,Galvao2024}, as well as complete evaluation of the solution with a case study, testing the adaptive solution against static protocol parameters.
