...
Evaluation should be done by means of a case study, where a protocol running should be reconfigured automatically to achieve better performance, which will be compared to non self-configuring alternatives.\todo{I re-wrote this to talk more about objectives.}
