...
applications" \cite{TARDIS2023}.\todo{Maybe I should move this somewhere else.}
...
\paragraph{Chapter~\ref{cha:conclusion}} Finally, this chapter presents the final conclusions on the developed solution, delving into its contributions, and also clarifying its limitations, while also proposing possible future work.\todo{Review this.}