...
In this thesis, we address the problem of managing parameters of peer-to-peer protocols that compose decentralized systems, focussing on less complex reconfigurations in order to explore different ways of managing such systems.\todo{Wrote here this new phrase. Review.}
...
Evaluation should be done by means of a case study, where a protocol running should be able to reconfigure automatically to achieve better performance, which will be compared to non self-configuring alternatives.\todo{I re-wrote this to talk more about objectives.}
